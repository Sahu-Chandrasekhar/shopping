...
const MyCart = () => {
    ...
    const getProduct = () => {
        fetch("http://localhost:5000/cartapi")
    ...
    const delPro = (pid) => {
        let url = "http://localhost:5000/cartapi/" + pid;
    ...
    const updateQty = (product, action) => {
        ...
        let url = "http://localhost:5000/cartapi/" + product.id;
        let postdata = {
    ...
    const save = () => {
        ...
        let url = "http://localhost:5000/orderapi";
        let postdata = {
            headers: { 'Content-Type': 'application/json' },
            method: "post",
